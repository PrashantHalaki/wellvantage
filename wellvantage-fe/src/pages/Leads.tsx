  ...
  return (
    <div className='h-full bg-background'>
      ...
      <div className='px-4 sm:px-6 lg:px-8 py-4 sm:py-6'>
        ...
        {/* Selection Info */}
        <p className='text-sm text-muted-foreground mb-4 italic'>60 of 120 leads selected</p>
          ...
          <table className='w-full min-w-[800px]'>
            ...
            <tbody>
              {mockLeads.map((lead, index) => (
                <tr
                  key={lead.id}
                  className={index !== mockLeads.length - 1 ? 'border-b border-border' : ''}
                >
                  ...
                  <td className='py-4 px-6'>
                    <Badge
                      variant='outline'
                      className={`${getInterestBadgeStyles(lead.interestLevel)} font-medium`}
                    >
                      {getInterestEmoji(lead.interestLevel)}
                      {lead.interestLevel}
                    </Badge>
                  </td>
                  <td className='py-4 px-6 text-foreground/80'>{lead.assignedTo}</td>
        ...
        <div className='flex flex-col sm:flex-row items-center justify-between sm:justify-end gap-4 mt-6'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <Button variant='default' size='icon' className='w-8 h-8 bg-primary'>
              3
            </Button>
